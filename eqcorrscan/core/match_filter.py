...
class Tribe(object):
    ...
    def detect(self, stream, threshold, threshold_type, trig_int, plotvar,
               ...
               group_size=None, overlap="calculate", debug=0, timeout=None,
               full_peaks=False):
        """
        ...
        for group in template_groups:
            group_party = _group_detect(
                ...
                full_peaks=full_peaks, timeout=timeout)
            party += group_party
        for family in party:
...
def _group_detect(templates, stream, threshold, threshold_type, trig_int,
                  ...
                  debug=0, full_peaks=False, timeout=None):
    """
